...
public class MySpaceForm extends BaseForm {
    ...
    public MySpaceForm(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        fab.addActionListener(e -> {
            ...
            int t = MySpaceForm.this.getTintColor();
            MySpaceForm.this.setTintColor(0);
            popup.showPopupDialog(new Rectangle(MySpaceForm.this.getWidth() - 10, MySpaceForm.this.getHeight() - 10, 10, 10));
            MySpaceForm.this.setTintColor(t);
