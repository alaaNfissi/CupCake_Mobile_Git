...
public class UserForm extends com.codename1.ui.Form {
	...
	private ScaleImageLabel myPic = new ScaleImageLabel();
...
//-- DON'T EDIT ABOVE THIS LINE!!! 
		...
		try {
			...
			FaceBookAccess.getInstance().getUser("me?fields=" + fields, me, new ActionListener() {
				...
				public void actionPerformed(ActionEvent evt) {
					...
					background.fetch();
					/*ScaleImageLabel myPic1 = new ScaleImageLabel();*/
					...
					//form.add(showShare());
					//gui_Container_1.replace(myPic, myPic1, null);
					/**
					 * **********************************************************
					 */
	...
	public void facebookLogout(UserForm form) {
